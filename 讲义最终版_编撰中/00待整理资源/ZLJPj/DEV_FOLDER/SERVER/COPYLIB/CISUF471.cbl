...
000850    03   ()元再リースコード１     PIC  X(1).
000860    03   ()元請求内訳コード１     PIC  X(3).
000870    03   ()元再リースコード２     PIC  X(1).
000880    03   ()元請求内訳コード２     PIC  X(3).
000890    03   ()元回収予定日１         PIC  X(7).
000900    03   ()実質利回り             PIC S9(2)V9(8)  SIGN LEADING SEPARATE.
000910    03   ()基準金利               PIC S9(2)V9(8)  SIGN LEADING SEPARATE.
000920    03   ()回収手順               PIC  X(1).
000930    03   ()解約日                 PIC  X(7).
000940    03   ()余白                   PIC  X(3).
