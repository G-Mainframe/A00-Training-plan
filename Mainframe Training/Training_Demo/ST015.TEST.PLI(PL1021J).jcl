...
//SYSLIN    DD DUMMY
//SYSPRINT  DD SYSOUT=*
//SYSLIB    DD DSN=ST015.TEST.PLI,DISP=SHR
...
//             DCB=BLKSIZE=1024
//SYSIN     DD DSN=ST015.TEST.PLI(PL1021S),DISP=SHR
...
//         DD  DSN=ST015.TEST.LOAD,DISP=SHR
...
//*        DD  *
//SYSLMOD DD DSN=ST015.TEST.LOAD(PL1021S),
//        DISP=SHR
//SYSPRINT DD  SYSOUT=*
//SYSUDUMP DD  SYSOUT=*
