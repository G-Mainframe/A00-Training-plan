...
var $config={
	...
	right			: 10,
	display			: true,
	contentUrl		: "/includes/pop/blogdaily.jsp",
	time : {
		slideIn			: 10,
		hold			: 10,
		slideOut		: 10
...
function PopUp(id, config){
	...
	this.imgMin = "/includes/pop/images/min.gif";
	this.imgMax = "/includes/pop/images/max.gif";
}
...
var __o={
	create : function (){
		...
		sBtn.style.cssText='position:absolute;\
							...
							height:15px;\
							\
							background-image:url("/includes/pop/images/min.gif");';
		...
		btn.style.cssText='position:absolute;\
							...
							height:15px;\
							\
							background-image:url("/includes/pop/images/close.gif");';
	...
	minimize : function (){
		//alert("minimize");
		this.mm = "min";
		this.moveTargetPosition = this.config.height - 24;
	...
	onresize : function (){
		...
		//	alert("t.clientHeight="+t.clientHeight);
		//	alert("t.scrollTop="+t.scrollTop);
		//	alert("dy="+dy);
...
function writeCookie(cookieName, value, hours)
{
  var expire = "";
  /**
  if(hours != null)
...
*/
	...
	var the_cookie = cookieName+"=viewed;path=/;domain=.bokee.net;expires=" + expires.toGMTString();
...
//		var displayMode = "eachTime";
	...
	var cookieName="bokeenet_blog_popup_next_display_time";
