<%@ Page Language="Fujitsu.COBOL" AutoEventWireup="true"  CodeFile="IoDetail.aspx.cobx" Inherits="IoDetail" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <link href="option.css" type="text/css" rel="stylesheet" />
    <title>IoDetail</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
			<asp:label id="lblTitle" style="Z-INDEX: 133; LEFT: 216px; POSITION: absolute; TOP: 24px" runat="server"
				Width="264px" Height="16px" Font-Size="Larger">商品入出庫明細照会</asp:label>
			<asp:textbox id="txtYear" style="Z-INDEX: 122; LEFT: 64px; POSITION: absolute; TOP: 88px"
				runat="server" Width="48px" Height="24px" CssClass="right" Font-Size="Small"
				ForeColor="Black" MaxLength="4" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px"></asp:textbox>
			...
			<asp:textbox id="txtMonth" style="Z-INDEX: 112; LEFT: 112px; POSITION: absolute; TOP: 88px"
				runat="server" Width="24px" Height="24px" CssClass="right" Font-Size="Small"
				ForeColor="Black" MaxLength="2" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px"></asp:textbox>
			...
			<asp:textbox id="txtCmdtNo" style="Z-INDEX: 114; LEFT: 136px; POSITION: absolute; TOP: 88px" runat="server" Width="80px" Height="24px" CssClass="right" Font-Size="Small" ForeColor="Black" MaxLength="5" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px"></asp:textbox>
			...
			<asp:table id="tblStock" style="Z-INDEX: 116; LEFT: 64px; POSITION: absolute; TOP: 168px" runat="server"
				...
				<asp:TableRow VerticalAlign="Middle" BorderWidth="1px" BorderColor="Black" HorizontalAlign="Center"
					ForeColor="Black" ID="row0" BackColor="PowderBlue" Font-Size="Small" Font-Names="ＭＳ ゴシック" runat="server">
					<asp:TableCell RowSpan="1" ColumnSpan="1" Font-Size="Small" HorizontalAlign="Center" BorderColor="Black"
						Text="入出庫日" ID="tblcelldate00" runat="server"></asp:TableCell>
				...
				<asp:TableRow VerticalAlign="Middle"
					HorizontalAlign="Center" Font-Size="X-Small" runat="server" ID="TableRow10">
			...
			<asp:label id="lblCmdtName" style="Z-INDEX: 120; LEFT: 216px; POSITION: absolute; TOP: 88px"
				runat="server" Width="232px" Height="24px" BorderWidth="1px" Font-Size="Small" ForeColor="Black" BorderStyle="Solid" BorderColor="Gray"></asp:label>
