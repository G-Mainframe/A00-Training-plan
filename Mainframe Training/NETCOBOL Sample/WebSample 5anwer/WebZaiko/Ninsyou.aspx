<%@ Page Language="Fujitsu.COBOL" AutoEventWireup="true"  CodeFile="Ninsyou.aspx.cobx" Inherits="Ninsyou" %>
...
<body>
    ...
    <div>
        ...
        <table style="z-index: 109; left: 110px; position: absolute; top: 125px">
            <tr>
                <td style="width: 100px; height: 35px">
                    <asp:Label ID="Label2" runat="server" BackColor="#FFC080" Style="z-index: 100; left: 8px;
            ...
            <tr>
                <td style="width: 100px; height: 35px">
                    <asp:Label ID="Label3" runat="server" BackColor="#FFC080" Style="z-index: 100; left: 8px;
        ...
        <asp:Button ID="btnStart" runat="server" Style="z-index: 102; left: 135px; position: absolute;
            top: 235px" Text="ログイン" Width="70px" OnClick="btnStart_Click" />
